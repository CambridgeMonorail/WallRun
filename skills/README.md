...
This directory is the canonical source for The Sign Age's portable `SKILL.md` definitions.

These skills are reusable workflow packages for AI-assisted development.

They give an agent or developer domain-specific guidance for building and operating signage software with this repository. Instead of generic help, they provide repeatable workflows for planning, debugging, verification, BrightSign deployment, signage layout design, player discovery, and review work.

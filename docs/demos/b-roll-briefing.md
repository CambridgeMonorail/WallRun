...
This video is a short developer-facing explainer for WallRun.
...
2. WallRun treats signage as something developers can build with familiar tools.
...
WallRun is about digital signage as software. That means the footage should communicate real systems, real screens, real environments, and real developer workflows. The imagery should feel grounded in infrastructure and implementation, not aspiration.
...
4. "not drag-and-drop." _(this line is cyan — the emphasis)_
...
3. `github.com/CambridgeMonorail/WallRun` _(monospace, violet)_

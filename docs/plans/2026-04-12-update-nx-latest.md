...
Upgrade the workspace from Nx 22.6.3 to the latest Nx release on a dedicated branch.

## Steps

1. Generate package updates and migrations with `pnpm exec nx migrate latest`.

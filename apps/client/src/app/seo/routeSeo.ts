...
const siteName = 'The Sign Age';
const siteHost = 'https://cambridgemonorail.github.io';
const siteBasePath = '/TheSignAge';
const siteImage = `${siteHost}${siteBasePath}/assets/images/social.png`;
const defaultDescription =
  'The Sign Age is a developer-first workspace for building real digital signage with modern web tooling, signage-ready UI primitives, and BrightSign deployment workflows.';
...
const buildComponentDocEntry = (options: {
  ...
  const title = `${options.name} Component Docs | The Sign Age`;
  ...
  return {
    ...
    structuredData: [
      ...
      buildBreadcrumbSchema([
        { name: 'The Sign Age', path: navigationConfig.paths.landing },
...
const routeSeoEntries: Record<string, RouteSeoEntry> = {
  [navigationConfig.paths.landing]: {
    title: 'The Sign Age | Digital Signage Framework For React And BrightSign',
    description:
    ...
    structuredData: [
      ...
      },
      {
        ...
        name: siteName,
        codeRepository: 'https://github.com/CambridgeMonorail/TheSignAge',
  ...
  [navigationConfig.paths.gettingStarted]: {
    title: 'Getting Started | The Sign Age',
    description:
    ...
    structuredData: [
      buildWebPageSchema(
        'Getting Started | The Sign Age',
        'Install signage components, scaffold a BrightSign-ready player app, and move from browser demo to deployable signage software.',
        navigationConfig.paths.gettingStarted,
      ),
      buildBreadcrumbSchema([
        { name: 'The Sign Age', path: navigationConfig.paths.landing },
        { name: 'Getting Started', path: navigationConfig.paths.gettingStarted },
      ]),
    ],
  },
  [navigationConfig.paths.tooling]: {
    title: 'Tooling And Deployment | The Sign Age',
    description:
    ...
    structuredData: [
      buildWebPageSchema(
        'Tooling And Deployment | The Sign Age',
        'Scaffold player apps, package for BrightSign, discover devices on your LAN, and install portable skills for signage engineering workflows.',
        navigationConfig.paths.tooling,
      ),
      buildBreadcrumbSchema([
        { name: 'The Sign Age', path: navigationConfig.paths.landing },
        { name: 'Tooling And Deployment', path: navigationConfig.paths.tooling },
      ]),
    ],
  },
  [navigationConfig.paths.components.library]: {
    title: 'Component Library | The Sign Age',
    description:
    ...
    structuredData: [
      buildWebPageSchema(
        'Component Library | The Sign Age',
        'Browse signage-oriented React components for distance readability, fixed-aspect layouts, and always-on BrightSign displays.',
        navigationConfig.paths.components.library,
      ),
      buildBreadcrumbSchema([
        { name: 'The Sign Age', path: navigationConfig.paths.landing },
        { name: 'Component Library', path: navigationConfig.paths.components.library },
      ]),
    ],
  },
  [navigationConfig.paths.gallery]: {
    title: 'Signage Gallery | The Sign Age',
    description:
  ...
  [navigationConfig.paths.components.index]: {
    title: 'Signage Components Reference | The Sign Age',
    description:
      'Reference documentation for signage primitives, layouts, blocks, and behaviour components in The Sign Age component library.',
    ...
    structuredData: [
      buildWebPageSchema(
        'Signage Components Reference | The Sign Age',
        'Reference documentation for signage primitives, layouts, blocks, and behaviour components in The Sign Age component library.',
        navigationConfig.paths.components.index,
      ),
      buildBreadcrumbSchema([
  ...
  [navigationConfig.paths.components.colorPalette]: {
    title: 'Color Palette | The Sign Age',
    description:
      'Review the accessibility-focused color system and contrast guidance used across The Sign Age demo and signage components.',
    canonicalPath: navigationConfig.paths.components.colorPalette,
    keywords: 'signage color palette, accessibility contrast, signage theme tokens',
    structuredData: [
      buildBreadcrumbSchema([
        { name: 'The Sign Age', path: navigationConfig.paths.landing },
        { name: 'Color Palette', path: navigationConfig.paths.components.colorPalette },
      ]),
    ],
  },
  [navigationConfig.paths.components.primitives.metricCard]: buildComponentDocEntry({
  ...
  [navigationConfig.paths.components.primitives.screenFrame]: buildComponentDocEntry({
  ...
  [navigationConfig.paths.components.primitives.eventCard]: buildComponentDocEntry({
  ...
  [navigationConfig.paths.components.primitives.announcementCard]: buildComponentDocEntry({
  ...
  [navigationConfig.paths.components.layouts.splitScreen]: buildComponentDocEntry({
  ...
  [navigationConfig.paths.components.layouts.signageContainer]: buildComponentDocEntry({
  ...
  [navigationConfig.paths.components.layouts.signageHeader]: buildComponentDocEntry({
  ...
  [navigationConfig.paths.components.blocks.fullscreenHero]: buildComponentDocEntry({
  ...
  [navigationConfig.paths.components.blocks.infoCardGrid]: buildComponentDocEntry({
  ...
  [navigationConfig.paths.components.behaviour.contentRotator]: buildComponentDocEntry({
  ...
  [navigationConfig.paths.components.behaviour.scheduleGate]: buildComponentDocEntry({
  ...
  [navigationConfig.paths.components.behaviour.autoPagingList]: buildComponentDocEntry({
  ...
  [navigationConfig.paths.components.behaviour.signageTransition]: buildComponentDocEntry({
  ...
  [navigationConfig.paths.components.behaviour.countdown]: buildComponentDocEntry({
  ...
  [navigationConfig.paths.components.behaviour.offlineFallback]: buildComponentDocEntry({
  ...
  [navigationConfig.paths.components.behaviour.staleDataIndicator]: buildComponentDocEntry({
  ...
  [navigationConfig.paths.signage.welcome]: {
    title: 'Welcome Screen Example | The Sign Age',
    description:
      'A welcome screen demo showing how The Sign Age handles fixed-aspect digital signage layouts for front-of-house displays.',
    canonicalPath: navigationConfig.paths.signage.welcome,
    keywords: 'welcome screen signage example, lobby display example, entrance screen design',
  },
  [navigationConfig.paths.signage.menu]: {
    title: 'Restaurant Menu Example | The Sign Age',
    description:
      'A digital menu board example built with The Sign Age signage components for distance readability and reliable display playback.',
    canonicalPath: navigationConfig.paths.signage.menu,
    keywords: 'restaurant menu board example, digital menu signage, cafe display example',
  },
  [navigationConfig.paths.signage.wayfinding]: {
    title: 'Office Directory Example | The Sign Age',
    description:
      'A wayfinding and office directory demo built with The Sign Age for large-format screens and deterministic layouts.',
    canonicalPath: navigationConfig.paths.signage.wayfinding,
    keywords: 'office directory signage example, wayfinding display example, directory screen React',
  },
  [navigationConfig.paths.signage.dashboard]: {
    title: 'KPI Dashboard Example | The Sign Age',
    description:
    ...
    keywords: 'KPI dashboard signage, operations dashboard display, metrics screen example',
  },
  [navigationConfig.paths.signage.announcements]: {
    title: 'Announcements Board Example | The Sign Age',
    description:
    ...
    keywords: 'announcements board example, digital notice board, message screen signage',
  },
  [navigationConfig.paths.signage.eventSchedule]: {
    title: 'Event Schedule Example | The Sign Age',
    description:
      'An event schedule signage example built for legible, timetable-style digital displays using The Sign Age.',
    canonicalPath: navigationConfig.paths.signage.eventSchedule,
    keywords: 'event schedule signage, timetable display example, venue schedule screen',
  },
  [navigationConfig.paths.signage.officeLobbyLoop]: {
    title: 'Office Lobby Loop Example | The Sign Age',
    description:
    ...
    keywords: 'office lobby loop, corporate lobby signage, rotating lobby screen example',
  },
  [navigationConfig.paths.signage.daypartMenu]: {
    title: 'Daypart Menu Example | The Sign Age',
    description:
      'A daypart menu example showing how The Sign Age can support time-based signage content and menu board presentation.',
    canonicalPath: navigationConfig.paths.signage.daypartMenu,
    keywords: 'daypart menu board, timed menu signage, breakfast lunch dinner display',
  },
  [navigationConfig.paths.notFound]: {
    title: 'Page Not Found | The Sign Age',
    description: defaultDescription,
    canonicalPath: navigationConfig.paths.landing,

...
export const IconTemplate: FC<IconProps> = (props) => {
  ...
  return (
    <svg width={size} height={size} viewBox="0 0 24 24" fill="none" style={props.style}>
      <rect x="4" y="3" width="16" height="18" rx="2" stroke={color} strokeWidth="1.5" />
      <path d="M9 2v2M15 2v2" stroke={color} strokeWidth="1.5" strokeLinecap="round" />
...
export const IconCursor: FC<IconProps> = (props) => {
  ...
  return (
    <svg width={size} height={size} viewBox="0 0 24 24" fill="none" style={props.style}>
      <path d="M5 3l12.5 8.5-5.5 1.5 3.5 6-2.5 1.5-3.5-6L5 18V3z" stroke={color} strokeWidth="1.5" strokeLinejoin="round" />
    </svg>
  );
};
...
export const IconMenu: FC<IconProps> = (props) => {
  ...
  return (
    <svg width={size} height={size} viewBox="0 0 24 24" fill="none" style={props.style}>
      <path d="M3 3v8a4 4 0 004 4h2v6M3 7h6" stroke={color} strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" />
      <path d="M17 3v18M21 3v6a4 4 0 01-4 4" stroke={color} strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" />
    </svg>
  );
};
...
export const IconBuilding: FC<IconProps> = (props) => {
  ...
  return (
    <svg width={size} height={size} viewBox="0 0 24 24" fill="none" style={props.style}>
      ...
      <path d="M9 22V18h6v4" stroke={color} strokeWidth="1.5" strokeLinejoin="round" />
      <rect x="8" y="6" width="3" height="3" rx="0.5" stroke={color} strokeWidth="1" />
      <rect x="13" y="6" width="3" height="3" rx="0.5" stroke={color} strokeWidth="1" />
      <rect x="8" y="11" width="3" height="3" rx="0.5" stroke={color} strokeWidth="1" />
      <rect x="13" y="11" width="3" height="3" rx="0.5" stroke={color} strokeWidth="1" />
    </svg>
  );
};
...
export const IconLayers: FC<IconProps> = (props) => {
  ...
  return (
    <svg width={size} height={size} viewBox="0 0 24 24" fill="none" style={props.style}>
      ...
      <path d="M2 12l10 5 10-5" stroke={color} strokeWidth="1.5" strokeLinejoin="round" />
      <path d="M2 17l10 5 10-5" stroke={color} strokeWidth="1.5" strokeLinejoin="round" />
    </svg>
  );
};
...
export const IconType: FC<IconProps> = (props) => {
  ...
  return (
    <svg width={size} height={size} viewBox="0 0 24 24" fill="none" style={props.style}>
      <path d="M4 21L12 3l8 18" stroke={color} strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" />
      <path d="M6.5 15h11" stroke={color} strokeWidth="1.5" strokeLinecap="round" />
    </svg>
  );
};
...
export const IconTerminal: FC<IconProps> = (props) => {
  ...
  return (
    <svg width={size} height={size} viewBox="0 0 24 24" fill="none" style={props.style}>
      <polyline points="4,17 10,12 4,7" stroke={color} strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" />
      <path d="M12 17h8" stroke={color} strokeWidth="1.5" strokeLinecap="round" />
    </svg>
  );
};
...
export const IconBot: FC<IconProps> = (props) => {
  ...
  return (
    <svg width={size} height={size} viewBox="0 0 24 24" fill="none" style={props.style}>
      ...
      <path d="M12 2v4M8 4h8" stroke={color} strokeWidth="1.5" strokeLinecap="round" />
    </svg>
  );
};
...
export const IconShield: FC<IconProps> = (props) => {
  ...
  return (
    <svg width={size} height={size} viewBox="0 0 24 24" fill="none" style={props.style}>
      <path d="M12 2l8 4v5c0 5.25-3.5 10-8 11.5C7.5 21 4 16.25 4 11V6l8-4z" stroke={color} strokeWidth="1.5" strokeLinejoin="round" />
